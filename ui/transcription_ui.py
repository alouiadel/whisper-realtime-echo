...
def create_file_section(file_picker, file_picker_result_handler, recorder_start_handler, recorder_stop_handler):
    ...
    format_hint = ft.Text(
        "Supported formats: wav, mp3, m4a, ogg, flac, opus, amr, mp4", size=12, color=ft.colors.GREY_500, italic=True
    )
    ...
    select_file_button = ft.ElevatedButton(
        ...
        on_click=lambda _: file_picker.pick_files(
            allow_multiple=False, allowed_extensions=["wav", "mp3", "m4a", "ogg", "flac", "opus", "amr", "mp4"]
        ),
        style=ft.ButtonStyle(
            color=ft.Colors.WHITE,
