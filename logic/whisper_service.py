...
class WhisperService:
    ...
    def transcribe(
        self, file_path, model_name, device, use_vad=True, vad_parameters=None, language=None, task="transcribe"
    ):
        ...
        def _transcribe_thread():
            try:
                ...
                segments, _ = model.transcribe(
                    file_path, vad_filter=use_vad, vad_parameters=vad_parameters, language=lang, task=task
                )
